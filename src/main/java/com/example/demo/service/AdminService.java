...
public class AdminService
{
    ...
    public AdminEntity signup(AdminRegisterDto input)
    {
        ...
        AdminEntity adminEntity=new AdminEntity(input.getUsername(),input.getName(),encodedPassword,input.getMail());
    ...
    {
        //Optional<AdminEntity> optionalAdmin=adminRepository.findByUsername(input.getUsername());
        AdminEntity adminEntity=adminRepository.findByUsername(input.getUsername());
        if (adminEntity == null) {
